...
import frc.robot.hardware.encoders.AbsoluteEncoderIOConfig;
...
public class SwerveConstants {
  ...
  private static final MotorIOConfig ANGLE_CONFIG =
      new MotorIOConfig()
          .withStatorLimit(20)
          .withSupplyLimit(20)
  ...
  public static final SwerveModule FRONT_LEFT_MODULE =
      SwerveModule.fromMeasuredValues(
          ...
          0.491242554389,
          0.0619252784977,
          AbsoluteEncoderIO.makeAnalogEncoder(
              SwerveWiring.FRONT_LEFT_ENCODER_ID,
              new AbsoluteEncoderIOConfig().withZeroReading(4.033805)));
  ...
  public static final SwerveModule FRONT_RIGHT_MODULE =
      SwerveModule.fromMeasuredValues(
          ...
          AbsoluteEncoderIO.makeAnalogEncoder(
              ...
              new AbsoluteEncoderIOConfig().withZeroReading(4.1971678)));
  ...
  public static final SwerveModule BACK_LEFT_MODULE =
      SwerveModule.fromMeasuredValues(
          ...
          AbsoluteEncoderIO.makeAnalogEncoder(
              ...
              new AbsoluteEncoderIOConfig().withZeroReading(0.13823008)));
  ...
  public static final SwerveModule BACK_RIGHT_MODULE =
      SwerveModule.fromMeasuredValues(
          ...
          AbsoluteEncoderIO.makeAnalogEncoder(
              ...
              new AbsoluteEncoderIOConfig().withZeroReading(5.5229199)));
}
